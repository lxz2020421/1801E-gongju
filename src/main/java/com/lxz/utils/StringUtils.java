...
public class StringUtils {
	...
	//方法3：返回参数l个中文汉字字符串，字符集必须在GB2312(相当于中文简体)范围内，例如“中”(5分)
	public static String randomChineseString(){
		String str=null;
		int high,low;
		Random random = new Random();
		high=(176+random.nextInt(40));
		random=new Random();
		low=161+random.nextInt(94);
		byte[] b=new byte[2];
	...
	public static String generateChineseName(){
		...
		String xing = str[RandomUtils.random(0, str.length-1)];
